				...
				<div id="main_content-left">
					...
					<div id="main_content-left-top">
						...
						<div style="height: 40px;">
							...
							<div>
								<!-- 默认全部 -->
								<a href="/FriendListServlet?method=friend_list" style="color:black">
									全部
								</a>
								<!-- 自定义分组 -->
						...
						<div >
						 	...
						 	<c:forEach  items="${requestScope.p.objects}" var="u">
						 		...
						 		<div class="users_info_list">
							 		...
							 		<div id="send_chat">
										<!-- 跳转到豆邮的详情---所有有关双方的豆邮 -->
										<a href="/chatServlet?method=chat_show&to_user_id=${u.userId}&nickname=${u.nickName}" target="_blank" style="color:black">
											 发豆邮
										</a>
									</div>
						 			<!-- 用户具体操作 -->
