...
body
{
	background-image:url('http://localhost:8090/image/login.jpg');
...
<!-- 登录的长方形界面框 -->
	...
	<!-- 获取cookie中的对象的值 -->
	 ...
	 <!-- 验证码的输入框 + 验证码图片 -->
		...
		<div>
			    <a href="/jsp/register.jsp" id="login_bottom_find"><font color=blue>忘记密码</font></a>
				<a href="/jsp/register.jsp" id="login_bottom_sign"><font color=blue>注册账号</font></a>
	    </div>
