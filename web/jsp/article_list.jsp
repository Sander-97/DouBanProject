									...
									<div class="item">
								        ...
								        <div class="header">
								            ...
								            <div class="author-img">
								                <a href="/ArticleShowServlet?method=article_show&article_id=${a.articleId}" target="_blank" style="margin: 5px 0px 5px 5px;">
								                	<img src="${a.authorImg}" style="width: 20px;height: 20px;border-radius: 2px;">
								                </a>
								            <!--作者的昵称 -->
								            <a href="/ArticleShowServlet?method=article_show&article_id=${a.articleId}" target="_blank"  id="author-nickname" style="margin: 5px 0px 5px 5px;color:black;">${a.authorNickName} </a>
								            </div>
