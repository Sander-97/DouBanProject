					 ...
					 <div >
						...
						<div >
									...
									<div class="header" >
										...
										<div class="right_part">	
								    		...
								    		<div  class="right_down_part">	
												<!-- 跳转到豆邮的详情---所有有关双方的豆邮 -->
												<a href="/chatServlet?method=chat_show&to_user_id=${a.fromUserId}&nickname=${a.fromUserNick}" target="_blank" style="color:black">
												    ${a.chatMsg}
												</a>
											</div>
										</div>
						 ...
						 <div id="paging">
								...
								<a href="chatServlet?method=${requestScope.method}&currentPage=1" id="first_page" class="page_contrller">首页</a>
								<!-- 利用el表达式的三目运算符进行判断 -->
								<a href="chatServlet?method=${requestScope.method}&currentPage=${(requestScope.p.currentPage==1)?1:requestScope.p.currentPage-1}" id="pervious_page"  class="page_contrller">上一页</a>
								<a href="chatServlet?method=${requestScope.method}&currentPage=${(requestScope.p.currentPage==requestScope.p.totalPage)?requestScope.p.totalPage:requestScope.p.currentPage+1}" id="next_page"  class="page_contrller">下一页</a>
								<a href="chatServlet?method=${requestScope.method}&currentPage=${requestScope.p.totalPage}" id="last_page"  class="page_contrller">尾页</a>
